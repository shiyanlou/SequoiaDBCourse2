...
在Java中上传LOB是需要先创建一个LOB对象，然后通过LOB对象向集群中写入数据。

1）双击打开LobUtil类，在 putLob() 方法中找到行**TODO  创建Lob**。
...
1）双击打开LobUtil类，在 listLob() 方法中找到行**TODO  查询Lob**
...
1）双击打开LobUtil类，在 getLob() 方法中找到行**TODO  下载Lob**
...
1）双击打开LobUtil类，在 removeLob() 方法中找到行 **TODO  删除Lob**
