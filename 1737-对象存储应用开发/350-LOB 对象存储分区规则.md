...
1）双击打开 LobPartitonUtil 类，在 createMainCL() 函数中找到行 TODO code2 创建分区方式为Range的主集合。
...
1）双击打开 LobPartitonUtil 类，在 createSubCL() 函数中找到行 TODO code3 创建分区方式为Hash的子集合。
...
1）双击打开 LobPartitonUtil 类，在 attachSubToMain( )函数中找到行 TODO code4 将子集合挂载到主集合。
