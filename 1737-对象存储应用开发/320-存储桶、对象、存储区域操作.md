...
1）鼠标移动到屏幕左边 BucketTest 类，右键点击，出现如图所示的选项条，左键单击Edit 'BucketTest' 选项。
...
3）鼠标移动到屏幕左边 BucketTest 类上，右键点击，出现如图所示的选项条，左键单击Run 'BucketTest' 选项。
...
1）鼠标移动到屏幕左边 ObjectTest 类，右键点击，出现如图所示的选项条，左键单击Edit 'ObjectTest' 选项。
...
3）鼠标移动到屏幕左边 ObjectTest 类上，右键点击，出现如图所示的选项条，左键单击Run 'ObjectTest' 选项。
...
1）鼠标移动到屏幕左边 RegionTest 类，右键点击，出现如图所示的选项条，左键单击Edit 'RegionTest' 选项。
...
3）鼠标移动到屏幕左边 RegionTest 类上，右键点击，出现如图所示的选项条，左键单击Run 'RegionTest' 选项。
