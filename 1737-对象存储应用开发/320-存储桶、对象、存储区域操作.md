...
SequoiaDB 巨杉数据库兼容 AWS S3 接口。本节课将通过 AWS SDK 进行S3操作。
...
![image-20200413162152328](https://doc.shiyanlou.com/courses/1738/1207281/347dc4a99782b31ea4c23860626cab26-0)
...
在该章节学习了 SequoiaS3 的相关知识。使用 AWS S3 接口操作 SequoiaS3，通过Java来操作存储桶、对象和区域。验证了SequoiaDB 巨杉数据库对 AWS S3 接口的兼容性。
