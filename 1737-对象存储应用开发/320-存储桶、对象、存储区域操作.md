...
![1586314006866](2 存储桶对象存储区域操作.assets\1737-2-01.png)

2）双击打开 PutBucket类，找到引导行**TODO 1 创建桶**，在该行下方粘贴代码

![1586314332058](2 存储桶对象存储区域操作.assets\1737-2-02.png)
...
![1586315131949](2 存储桶对象存储区域操作.assets\1737-2-03.png)
...
![1586315360507](2 存储桶对象存储区域操作.assets\1737-2-04.png)
...
![1586316258544](2 存储桶对象存储区域操作.assets\1737-2-05.png)
...
![1586325252362](2 存储桶对象存储区域操作.assets\1737-2-06.png)

出现如下界面，选择BucketTest，然后在**Program arguments**方框内输入 1 。

![1586325611801](2 存储桶对象存储区域操作.assets/1737-2-07.png)
...
![1586327448736](2 存储桶对象存储区域操作.assets/1737-2-08.png)
...
![1586325252362](2 存储桶对象存储区域操作.assets/1737-2-09.png)
...
![1586325965506](2 存储桶对象存储区域操作.assets/1737-2-10.png)

2）双击打开ObjectPut类，找到引导行 **TODO 1 将指定内容保存为对象**

引导行位置

![1586328212269](2 存储桶对象存储区域操作.assets/1737-2-11.png)
...
![1586329140259](2 存储桶对象存储区域操作.assets/1737-2-12.png)
...
![image-20200411144210494](E:\巨杉\s3\新建文件夹\2 存储桶对象存储区域操作.assets\1737-2-13.png)
...
![image-20200411144252246](E:\巨杉\s3\新建文件夹\2 存储桶对象存储区域操作.assets\1737-2-14.png)
...
![image-20200411144348372](E:\巨杉\s3\新建文件夹\2 存储桶对象存储区域操作.assets\1737-2-15.png)
...
![image-20200411151013818](E:\巨杉\s3\新建文件夹\2 存储桶对象存储区域操作.assets\1737-2-16.png)

出现如下界面，选择ObjectTest，然后在**Program arguments**方框内输入 1 。

![image-20200411150942195](E:\巨杉\s3\新建文件夹\2 存储桶对象存储区域操作.assets\1737-2-17.png)
