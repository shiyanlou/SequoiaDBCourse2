...
MySQL数据库中提供了很丰富的函数。MySQL函数包括数学函数、字符串函数、日期和时间函数、条件判断函数、系统信息函数、加密函数、格式化函数等。通过这些函数，可以简化用户的操作。例如，字符串连接函数可以很方便的将多个字符串连接在一起。在这一章节中将讲解的内容包括：字符串检索函数、字符串处理函数、聚合函数、日期时间函数、系统信息函数、加密函数。
...
打开lesson7_function packge，在该packge中完成后续课程。
...
打开FunctionTest.java，修改第71行findInSet方法中的TODO
...
打开FunctionTest.java，修改第66行locate方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为locate
...
打开FunctionTest.java，修改第61行lower方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为lower
...
打开FunctionTest.java，修改第56行avg方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为avg
...
打开FunctionTest.java，修改第51行dateFunction1方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为dateFunction1
...
打开FunctionTest.java，修改第46行dateFunction2方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为dateFunction2
...
打开FunctionTest.java，修改第41行dateFunction3方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为dateFunction3
...
打开FunctionTest.java，修改第36行dateFunction4方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为dateFunction4
...
打开FunctionTest.java，修改第31行systemFunction1方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为systemFunction1
...
打开FunctionTest.java，修改第26行systemFunction2方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为systemFunction2
...
打开FunctionTest.java，修改第21行encryptionFunction1方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为encryptionFunction1
...
打开FunctionTest.java，修改第16行encryptionFunction2方法中的TODO
...
右键FunctionMainTest,选择Edit，修改参数为encryptionFunction2
...
打开FunctionTest.java，修改第11行encryptionFunction3方法中的TODO
