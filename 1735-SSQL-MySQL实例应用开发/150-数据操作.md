...
打开UpdateTest.java，修改第47行insert方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为insert，再次右键CRUDMainTest，选择Run，执行代码
...
打开UpdateTest.java，修改第42行insertSelect方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为insertSelect，再次右键CRUDMainTest，选择Run，执行代码
...
打开UpdateTest.java，修改第37行createAsSelect方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为createAsSelect，再次右键CRUDMainTest，选择Run，执行代码
...
打开UpdateTest.java，修改第32行delete方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为delete，再次右键CRUDMainTest，选择Run，执行代码
...
打开UpdateTest.java，修改第27行truncate方法的TODO

```java
stmt = conn.createStatement();
String sql = "truncate table employee";
stmt.executeUpdate(sql);
String sql3 = "desc employee;";
rs = stmt.executeQuery(sql3);
while (rs.next()) {
    for (int i = 1; i <= rs.getMetaData().getColumnCount() ; i++) {
        System.out.print(rs.getString(i)+"\t");
...
右键CRUDMainTest,选择Edit，修改参数为truncate，再次右键CRUDMainTest，选择Run，执行代码
...
打开UpdateTest.java，修改第22行drop方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为drop，再次右键CRUDMainTest，选择Run，执行代码

## update

将表employee中name为Parto的age修改为23

打开UpdateTest.java，修改第17行update方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为update，再次右键CRUDMainTest，选择Run，执行代码
...
打开UpdateTest.java，修改第12行replace方法的TODO
...
右键CRUDMainTest,选择Edit，修改参数为replace，再次右键CRUDMainTest，选择Run，执行代码
