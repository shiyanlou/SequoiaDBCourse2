...
将代码样例粘贴到 BsonObject 类 useBsonObject 方法 code 1 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 BsonList 类 useBsonList 方法 code 2 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 Id 类 useId 方法 code 3 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 Date 类 useDate 方法 code 4 的 TODO ~ TODO END 位置区间内。
...
配置 Configuration 页中的 Program arguments 选项，写入指定的参数 useDate ，点击”OK“。
...
将代码样例粘贴到 TimeStamp 类 useTimeStamp 方法 code 5 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 Binary 类 useBinary 方法 code 6 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 Regex 类 useRegex 方法 code 7 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 HighNumber 类 useHighNumber 方法 code 8 的 TODO ~ TODO END 位置区间内。
...
将代码样例粘贴到 Lob 类 useLob 方法 code 9 的 TODO ~ TODO END 位置区间内。
